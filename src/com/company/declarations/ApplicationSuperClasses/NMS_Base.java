...
public class NMS_Base {
    ...
    public <T> String getUID_Base (Class<T> resultClass, String uriIn, String itemName) throws IllegalAccessException {
        String sOut = null;
        ...
        for (T item:respond) {
            ...
            for (Field field1:fields){
                ...
                if (field1.getName().equals("UID")){
                    uid = field1.get(item);
                    continue;
                }
            }
            if (name.toString().equals(itemName)) {
                sOut = uid.toString();
                break;
            }
        }
